"""This script converts data in panoptic COCO format to semantic
segmentation. All segments with the same semantic class in one image are
combined together.
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="This script converts data in panoptic COCO format to  "
                    "semantic segmentation. All segments with the same "
                    "semantic class in one image are combined together. See "
                    "this file's head for more information.")
    ...
    parser.add_argument('--output_json_file', type=str, default=None,
                        help="JSON file with semantic data. If "
                             "'--output_json_file' is specified, resulting "
                             "semantic segmentation will be stored as a JSON "
                             "file in COCO stuff format：see "
                             "http://cocodataset.org/#format-data for details")
    parser.add_argument('--semantic_seg_folder', type=str, default=None,
                        help="Folder for semantic segmentation. If "
                             "'--semantic_seg_folder' is specified, "
                             "resulting semantic segmentation will be stored "
                             "in the specified folder in PNG format.")
