...
from mmdet.core import IdGenerator, MyJsonEncoder
...
# whatever you like. Make sure to provide your results using the original
# IDs and not the training IDs. Note that many IDs are ignored in evaluation
...
# -----------------------------------------------------------------------------
# panoptic converter for cityscape
# -----------------------------------------------------------------------------
